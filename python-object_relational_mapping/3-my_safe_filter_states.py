...
# Once again, write a script that takes in arguments and displays all values in the states 
# table of hbtn_0e_0_usa where name matches the argument. But this time, write one that is
